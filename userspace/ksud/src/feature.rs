...
impl FeatureId {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::WebSuPrompt => "web_su_prompt",
        }
    }
    ...
    pub const fn description(self) -> &'static str {
        match self {
            ...
            Self::WebSuPrompt => {
                "Web SU Prompt - asks the local web admin before granting root to new UIDs"
            }
        }
    }
}
...
fn parse_feature_id(name: &str) -> Result<FeatureId> {
    match name {
        ...
        "web_su_prompt" | "5" => Ok(FeatureId::WebSuPrompt),
